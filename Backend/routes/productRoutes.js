...
const { getAllProducts,createproduct,updateProducts,deleteProducts,getProductDetails,createProductReviews, getproductReviews, deleteReview } = require('../controllers/productController');
